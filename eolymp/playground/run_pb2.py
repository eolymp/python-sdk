...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_RUN']._serialized_end=592
  _globals['_RUN_STATUS']._serialized_start=419
  _globals['_RUN_STATUS']._serialized_end=592

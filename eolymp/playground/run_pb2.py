...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_RUN']._serialized_end=573
  _globals['_RUN_STATUS']._serialized_start=400
  _globals['_RUN_STATUS']._serialized_end=573

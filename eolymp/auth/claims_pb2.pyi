...
class Claims(_message.Message):
    __slots__ = ["birthday", "country", "email", "email_restricted", "email_verified", "id", "issuer", "locale", "minor", "name", "nickname", "picture", "preferred_runtime", "restrictions", "session_id", "subject", "timezone"]

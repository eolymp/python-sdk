...
class SecurityEvent(_message.Message):
    ...
    class Event(_message.Message):
        __slots__ = ["claims", "reason", "state", "subjects", "token", "token_identifier_alg", "token_type", "type"]
        ...
        reason: str
        state: str
        subjects: SecurityEvent.Subject
        token: str
        token_identifier_alg: str
        token_type: str
        type: str
        def __init__(self, type: _Optional[str] = ..., subjects: _Optional[_Union[SecurityEvent.Subject, _Mapping]] = ..., claims: _Optional[_Union[_claims_pb2.Claims, _Mapping]] = ..., reason: _Optional[str] = ..., state: _Optional[str] = ..., token: _Optional[str] = ..., token_type: _Optional[str] = ..., token_identifier_alg: _Optional[str] = ...) -> None: ...

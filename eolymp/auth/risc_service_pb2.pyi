...
class SecurityEvent(_message.Message):
    ...
    class Event(_message.Message):
        __slots__ = ["reason", "state", "subject", "token", "token_identifier_alg", "token_type", "type"]
        ...
        token_type: str
        type: str
        def __init__(self, type: _Optional[str] = ..., subject: _Optional[_Union[SecurityEvent.Subject, _Mapping]] = ..., reason: _Optional[str] = ..., state: _Optional[str] = ..., token: _Optional[str] = ..., token_type: _Optional[str] = ..., token_identifier_alg: _Optional[str] = ...) -> None: ...
    class Subject(_message.Message):
        __slots__ = ["email", "format", "iss", "sub"]
        ...
        iss: str
        sub: str
        def __init__(self, format: _Optional[str] = ..., iss: _Optional[str] = ..., sub: _Optional[str] = ..., email: _Optional[str] = ...) -> None: ...

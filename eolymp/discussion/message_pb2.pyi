...
class Message(_message.Message):
    __slots__ = ["edited_at", "id", "member_id", "message", "posted_at", "reply_count", "reply_to", "thread_id", "vote_count"]

...
class Post(_message.Message):
    __slots__ = ["content", "created_at", "draft", "featured", "id", "image_url", "labels", "links", "locale", "member_id", "moderation", "preview", "public", "published_at", "reply_count", "source_id", "source_url", "title", "type_id", "updated_at", "url", "user_id", "vote", "vote_count"]

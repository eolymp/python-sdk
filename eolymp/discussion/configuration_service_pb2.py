...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['_CONFIGURATIONSERVICE'].methods_by_name['DescribeDiscussionConfig']._options = None
  ...
  _globals['_CONFIGURATIONSERVICE'].methods_by_name['UpdateDiscussionConfig']._options = None

...
class Vendor(_message.Message):
    ...
    class Status(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        __slots__ = ()
        UNKNOWN_STATUS: _ClassVar[Vendor.Status]
        DRAFT: _ClassVar[Vendor.Status]
        REVIEW: _ClassVar[Vendor.Status]
        APPROVED: _ClassVar[Vendor.Status]
        ACTIVE: _ClassVar[Vendor.Status]
        REJECTED: _ClassVar[Vendor.Status]
    UNKNOWN_STATUS: Vendor.Status
    DRAFT: Vendor.Status

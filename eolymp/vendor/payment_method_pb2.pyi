...
class PaymentMethod(_message.Message):
    ...
    class TransferACH(_message.Message):
        __slots__ = ("routing_number", "account_number")
        ROUTING_NUMBER_FIELD_NUMBER: _ClassVar[int]
        ACCOUNT_NUMBER_FIELD_NUMBER: _ClassVar[int]
        routing_number: str
        account_number: str
        def __init__(self, routing_number: _Optional[str] = ..., account_number: _Optional[str] = ...) -> None: ...

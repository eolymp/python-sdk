...
class PaymentMethod(_message.Message):
    __slots__ = ("id", "name", "default", "country", "sepa_transfer", "swift_transfer", "crypto_transfer", "neft_transfer")
    ...
    class TransferNEFT(_message.Message):
        __slots__ = ("account_number", "ifsc_code")
        ACCOUNT_NUMBER_FIELD_NUMBER: _ClassVar[int]
        IFSC_CODE_FIELD_NUMBER: _ClassVar[int]
        account_number: str
        ifsc_code: str
        def __init__(self, account_number: _Optional[str] = ..., ifsc_code: _Optional[str] = ...) -> None: ...
    ...
    def __init__(self, id: _Optional[str] = ..., name: _Optional[str] = ..., default: bool = ..., country: _Optional[str] = ..., sepa_transfer: _Optional[_Union[PaymentMethod.TransferSEPA, _Mapping]] = ..., swift_transfer: _Optional[_Union[PaymentMethod.TransferSWIFT, _Mapping]] = ..., crypto_transfer: _Optional[_Union[PaymentMethod.TransferCrypto, _Mapping]] = ..., neft_transfer: _Optional[_Union[PaymentMethod.TransferNEFT, _Mapping]] = ...) -> None: ...

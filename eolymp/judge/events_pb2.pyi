...
class ScoreUpdatedEvent(_message.Message):
    __slots__ = ["contest_id", "participant_id", "score"]
    CONTEST_ID_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, contest_id: _Optional[str] = ..., participant_id: _Optional[str] = ..., score: _Optional[_Union[_score_pb2.Score, _Mapping]] = ...) -> None: ...

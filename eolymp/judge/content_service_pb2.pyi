...
class DescribeFragmentInput(_message.Message):
    __slots__ = ("contest_id", "fragment_id", "locale", "extra")
    ...
    def __init__(self, contest_id: _Optional[str] = ..., fragment_id: _Optional[str] = ..., locale: _Optional[str] = ..., extra: _Optional[_Iterable[_Union[_content_fragment_pb2.Fragment.Extra.Field, str]]] = ...) -> None: ...
...
class ListFragmentsInput(_message.Message):
    __slots__ = ("contest_id", "offset", "size", "filters", "sort", "order", "locale", "extra")
    class Sort(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        __slots__ = ()
        UNKNOWN_SORT: _ClassVar[ListFragmentsInput.Sort]
        PATH: _ClassVar[ListFragmentsInput.Sort]
        CREATED_AT: _ClassVar[ListFragmentsInput.Sort]
    UNKNOWN_SORT: ListFragmentsInput.Sort
...
class CreateFragmentInput(_message.Message):
    __slots__ = ("contest_id", "fragment")
    CONTEST_ID_FIELD_NUMBER: _ClassVar[int]
    FRAGMENT_FIELD_NUMBER: _ClassVar[int]
    contest_id: str
    fragment: _content_fragment_pb2.Fragment
    def __init__(self, contest_id: _Optional[str] = ..., fragment: _Optional[_Union[_content_fragment_pb2.Fragment, _Mapping]] = ...) -> None: ...
...
class UpdateFragmentInput(_message.Message):
    __slots__ = ("contest_id", "fragment_id", "locale", "fragment")
    CONTEST_ID_FIELD_NUMBER: _ClassVar[int]
    FRAGMENT_ID_FIELD_NUMBER: _ClassVar[int]
    LOCALE_FIELD_NUMBER: _ClassVar[int]
    FRAGMENT_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, contest_id: _Optional[str] = ..., fragment_id: _Optional[str] = ..., locale: _Optional[str] = ..., fragment: _Optional[_Union[_content_fragment_pb2.Fragment.Patch, _Mapping]] = ...) -> None: ...
...
class DeleteFragmentInput(_message.Message):
    __slots__ = ("contest_id", "fragment_id", "locale")
    CONTEST_ID_FIELD_NUMBER: _ClassVar[int]
    FRAGMENT_ID_FIELD_NUMBER: _ClassVar[int]
    LOCALE_FIELD_NUMBER: _ClassVar[int]
    contest_id: str
    fragment_id: str
    locale: str
    def __init__(self, contest_id: _Optional[str] = ..., fragment_id: _Optional[str] = ..., locale: _Optional[str] = ...) -> None: ...
...
class TranslateFragmentInput(_message.Message):
    __slots__ = ("contest_id", "fragment_id", "source", "target", "target_automatic", "override_manual")
    CONTEST_ID_FIELD_NUMBER: _ClassVar[int]
    FRAGMENT_ID_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, contest_id: _Optional[str] = ..., fragment_id: _Optional[str] = ..., source: _Optional[str] = ..., target: _Optional[_Iterable[str]] = ..., target_automatic: _Optional[bool] = ..., override_manual: _Optional[bool] = ...) -> None: ...
...
class DescribePathInput(_message.Message):
    __slots__ = ("contest_id", "path", "locale", "extra")
    CONTEST_ID_FIELD_NUMBER: _ClassVar[int]
    PATH_FIELD_NUMBER: _ClassVar[int]
    LOCALE_FIELD_NUMBER: _ClassVar[int]
    EXTRA_FIELD_NUMBER: _ClassVar[int]
    ...
    locale: str
    extra: _containers.RepeatedScalarFieldContainer[_content_fragment_pb2.Fragment.Extra.Field]
    def __init__(self, contest_id: _Optional[str] = ..., path: _Optional[str] = ..., locale: _Optional[str] = ..., extra: _Optional[_Iterable[_Union[_content_fragment_pb2.Fragment.Extra.Field, str]]] = ...) -> None: ...

...
class Contest(_message.Message):
    __slots__ = ["domain", "duration", "ends_at", "ends_in", "ern", "format", "id", "name", "participation_mode", "space_id", "starts_at", "starts_in", "status", "visibility"]
    ...
    class Scoring(_message.Message):
        __slots__ = ["attempt_penalty", "freezing_time", "show_scoreboard", "upsolving"]
        ...
        UPSOLVING_FIELD_NUMBER: _ClassVar[int]
        attempt_penalty: int
        freezing_time: int
        show_scoreboard: bool
        upsolving: bool
        def __init__(self, show_scoreboard: bool = ..., attempt_penalty: _Optional[int] = ..., freezing_time: _Optional[int] = ..., upsolving: bool = ...) -> None: ...

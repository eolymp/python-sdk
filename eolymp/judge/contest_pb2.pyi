...
class Contest(_message.Message):
    ...
    class Scoring(_message.Message):
        __slots__ = ["attempt_penalty", "freezing_time", "show_scoreboard"]
        ...
        def __init__(self, show_scoreboard: bool = ..., attempt_penalty: _Optional[int] = ..., freezing_time: _Optional[int] = ...) -> None: ...

...
class CreateSubmissionInput(_message.Message):
    __slots__ = ("contest_id", "problem_id", "lang", "source", "output", "quiz", "widget")
    CONTEST_ID_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, contest_id: _Optional[str] = ..., problem_id: _Optional[str] = ..., lang: _Optional[str] = ..., source: _Optional[str] = ..., output: _Optional[_Union[_submission_pb2.Submission.Output, _Mapping]] = ..., quiz: _Optional[_Union[_submission_pb2.Submission.Quiz, _Mapping]] = ..., widget: _Optional[_Union[_submission_pb2.Submission.Widget, _Mapping]] = ...) -> None: ...
...
class WatchSubmissionOutput(_message.Message):
    ...
    def __init__(self, submission: _Optional[_Union[_submission_pb2_1.Submission, _Mapping]] = ..., event: _Optional[_Union[_watch_pb2.WatchEventType, str]] = ...) -> None: ...
...
class WatchSubmissionsListInput(_message.Message):
    ...
    contest_id: str
    extra: _containers.RepeatedScalarFieldContainer[_submission_pb2_1.Submission.Extra]
    def __init__(self, contest_id: _Optional[str] = ..., extra: _Optional[_Iterable[_Union[_submission_pb2_1.Submission.Extra, str]]] = ...) -> None: ...
...
class WatchSubmissionsListOutput(_message.Message):
    ...
    event: _watch_pb2.WatchEventType
    submission: _submission_pb2_1.Submission
    def __init__(self, event: _Optional[_Union[_watch_pb2.WatchEventType, str]] = ..., submission: _Optional[_Union[_submission_pb2_1.Submission, _Mapping]] = ...) -> None: ...

...
class ListParticipantsInput(_message.Message):
    ...
    class Filter(_message.Message):
        __slots__ = ("id", "member_id", "group_id", "status", "started_at", "unofficial", "disqualified", "inactive", "role", "staff")

...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['_REGISTRATIONSERVICE'].methods_by_name['DescribeRegistration']._options = None
  ...
  _globals['_REGISTRATIONSERVICE'].methods_by_name['SubmitRegistration']._options = None

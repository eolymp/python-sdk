...
from eolymp.judge import feedback_pb2 as _feedback_pb2
...
class Problem(_message.Message):
    __slots__ = ["base_id", "contest_id", "feedback_policy", "file_size_limit", "id", "index", "memory_limit", "score", "score_by_best_testset", "submit_limit", "time_limit"]

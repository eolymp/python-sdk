...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['_SCOREBOARDSERVICE'].methods_by_name['DescribeScoreboard']._options = None
  ...
  _globals['_SCOREBOARDSERVICE'].methods_by_name['ListScoreboardRows']._options = None

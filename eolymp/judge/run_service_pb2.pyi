...
from eolymp.atlas import run_pb2 as _run_pb2
...
class CreateRunInput(_message.Message):
    __slots__ = ("contest_id", "problem_id", "runtime", "trace", "source", "input_data", "input_ref", "example_id")
    ...
    input_ref: str
    example_id: str
    def __init__(self, contest_id: _Optional[str] = ..., problem_id: _Optional[str] = ..., runtime: _Optional[str] = ..., trace: _Optional[bool] = ..., source: _Optional[str] = ..., input_data: _Optional[bytes] = ..., input_ref: _Optional[str] = ..., example_id: _Optional[str] = ...) -> None: ...
...
class DescribeRunInput(_message.Message):
    __slots__ = ("contest_id", "problem_id", "run_id")
    CONTEST_ID_FIELD_NUMBER: _ClassVar[int]
    PROBLEM_ID_FIELD_NUMBER: _ClassVar[int]
    RUN_ID_FIELD_NUMBER: _ClassVar[int]
    contest_id: str
    problem_id: str
    run_id: str
    def __init__(self, contest_id: _Optional[str] = ..., problem_id: _Optional[str] = ..., run_id: _Optional[str] = ...) -> None: ...

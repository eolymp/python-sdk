...
class Certificate(_message.Message):
    __slots__ = ("id", "member_id", "target_id", "verification_url", "download_url", "html_url", "type", "attributes", "issued_at", "expires_at")

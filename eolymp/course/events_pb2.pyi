...
class MaterialChangedEvent(_message.Message):
    ...
    def __init__(self, before: _Optional[_Union[_material_pb2.Material, _Mapping]] = ..., after: _Optional[_Union[_material_pb2.Material, _Mapping]] = ...) -> None: ...
...
class ModuleChangedEvent(_message.Message):
    ...
    def __init__(self, before: _Optional[_Union[_module_pb2.Module, _Mapping]] = ..., after: _Optional[_Union[_module_pb2.Module, _Mapping]] = ...) -> None: ...
...
class StudentChangedEvent(_message.Message):
    ...
    def __init__(self, before: _Optional[_Union[_student_pb2.Student, _Mapping]] = ..., after: _Optional[_Union[_student_pb2.Student, _Mapping]] = ...) -> None: ...

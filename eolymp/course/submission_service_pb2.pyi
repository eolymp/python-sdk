...
class CreateSubmissionInput(_message.Message):
    __slots__ = ("course_id", "material_id", "runtime", "source", "output", "quiz", "widget")
    ...
    def __init__(self, course_id: _Optional[str] = ..., material_id: _Optional[str] = ..., runtime: _Optional[str] = ..., source: _Optional[str] = ..., output: _Optional[_Union[_submission_pb2.Submission.Output, _Mapping]] = ..., quiz: _Optional[_Union[_submission_pb2.Submission.Quiz, _Mapping]] = ..., widget: _Optional[_Union[_submission_pb2.Submission.Widget, _Mapping]] = ...) -> None: ...
...
class ListSubmissionsInput(_message.Message):
    __slots__ = ("material_id", "course_id", "after", "size", "filters")
    ...
    def __init__(self, material_id: _Optional[str] = ..., course_id: _Optional[str] = ..., after: _Optional[str] = ..., size: _Optional[int] = ..., filters: _Optional[_Union[ListSubmissionsInput.Filter, _Mapping]] = ...) -> None: ...
...
class DescribeSubmissionInput(_message.Message):
    __slots__ = ("material_id", "course_id", "submission_id")
    MATERIAL_ID_FIELD_NUMBER: _ClassVar[int]
    COURSE_ID_FIELD_NUMBER: _ClassVar[int]
    SUBMISSION_ID_FIELD_NUMBER: _ClassVar[int]
    material_id: str
    course_id: str
    submission_id: str
    def __init__(self, material_id: _Optional[str] = ..., course_id: _Optional[str] = ..., submission_id: _Optional[str] = ...) -> None: ...

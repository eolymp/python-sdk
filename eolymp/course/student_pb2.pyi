...
class Student(_message.Message):
    __slots__ = ["assignments", "graded_at", "grades", "id", "inactive", "member_id", "overall_grade", "overall_progress", "updated_at"]

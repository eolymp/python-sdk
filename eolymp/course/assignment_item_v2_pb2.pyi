...
class AssignmentItemV2(_message.Message):
    __slots__ = ["excused", "grade", "graded_at", "module_item_id", "progress"]
    ...
    module_item_id: str
    progress: float
    def __init__(self, module_item_id: _Optional[str] = ..., progress: _Optional[float] = ..., grade: _Optional[int] = ..., excused: bool = ..., graded_at: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ...) -> None: ...

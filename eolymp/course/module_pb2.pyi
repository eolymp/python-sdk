...
class Module(_message.Message):
    __slots__ = ["complete_before", "description", "draft", "duration", "extra", "grade", "id", "image_url", "index", "name", "percentage", "progress", "start_after", "url"]

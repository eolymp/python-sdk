...
class Module(_message.Message):
    __slots__ = ["assignment", "complete_before", "description", "draft", "duration", "extra", "grade", "id", "image_url", "index", "name", "progress", "start_after", "url"]

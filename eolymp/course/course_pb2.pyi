...
class Course(_message.Message):
    ...
    class Patch(_message.Message):
        __slots__ = ("locale", "name", "description", "image_url", "visibility", "duration", "topics", "unset_topics")
        ...
        unset_topics: bool
        def __init__(self, locale: _Optional[str] = ..., name: _Optional[str] = ..., description: _Optional[_Union[_content_pb2.Content, _Mapping]] = ..., image_url: _Optional[str] = ..., visibility: _Optional[_Union[Course.Visibility, str]] = ..., duration: _Optional[int] = ..., topics: _Optional[_Iterable[str]] = ..., unset_topics: _Optional[bool] = ...) -> None: ...

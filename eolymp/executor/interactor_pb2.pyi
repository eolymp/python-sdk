...
class Interactor(_message.Message):
    ...
    def __init__(self, type: _Optional[_Union[Interactor.Type, str]] = ..., runtime: _Optional[str] = ..., source_url: _Optional[str] = ..., secret: _Optional[bool] = ..., files: _Optional[_Iterable[_Union[_file_pb2.File, _Mapping]]] = ...) -> None: ...

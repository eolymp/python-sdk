...
class Checker(_message.Message):
    ...
    def __init__(self, type: _Optional[_Union[Checker.Type, str]] = ..., runtime: _Optional[str] = ..., source_url: _Optional[str] = ..., precision: _Optional[int] = ..., case_sensitive: _Optional[bool] = ..., order_sensitive: _Optional[bool] = ..., files: _Optional[_Iterable[_Union[_file_pb2.File, _Mapping]]] = ...) -> None: ...

...
class PostType(_message.Message):
    ...
    def __init__(self, id: _Optional[str] = ..., name: _Optional[str] = ..., hidden: _Optional[bool] = ..., order: _Optional[int] = ..., variants: _Optional[_Iterable[_Union[PostType.Variant, _Mapping]]] = ...) -> None: ...

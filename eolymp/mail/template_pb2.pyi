...
class Template(_message.Message):
    ...
    class Extra(_message.Message):
        ...
        class Field(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
            ...
            CONTENT: _ClassVar[Template.Extra.Field]
        UNKNOWN_EXTRA: Template.Extra.Field
        CONTENT: Template.Extra.Field
        def __init__(self) -> None: ...
    class Patch(_message.Message):
        __slots__ = ("key", "draft", "subject", "automatic", "content")
        ...
        automatic: bool
        content: str
        def __init__(self, key: _Optional[str] = ..., draft: _Optional[bool] = ..., subject: _Optional[str] = ..., automatic: _Optional[bool] = ..., content: _Optional[str] = ...) -> None: ...

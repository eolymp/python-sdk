...
class Scoreboard(_message.Message):
    ...
    class Row(_message.Message):
        ...
        class Value(_message.Message):
            __slots__ = ["attempts", "column_id", "id", "penalty", "percentage", "score", "solved_in", "timeline_offset_end", "timeline_offset_start", "timeline_set", "value_number", "value_string"]
            ...
            value_number: int
            value_string: str
            def __init__(self, id: _Optional[str] = ..., column_id: _Optional[str] = ..., timeline_set: bool = ..., timeline_offset_start: _Optional[int] = ..., timeline_offset_end: _Optional[int] = ..., score: _Optional[float] = ..., penalty: _Optional[float] = ..., percentage: _Optional[float] = ..., attempts: _Optional[int] = ..., solved_in: _Optional[int] = ..., value_string: _Optional[str] = ..., value_number: _Optional[int] = ...) -> None: ...

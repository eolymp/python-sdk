...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['_CONFIGURATIONSERVICE'].methods_by_name['DescribeIdentityConfig']._options = None
  ...
  _globals['_CONFIGURATIONSERVICE'].methods_by_name['ConfigureIdentityConfig']._options = None

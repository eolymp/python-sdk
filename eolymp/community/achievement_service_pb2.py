...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['_ACHIEVEMENTSERVICE'].methods_by_name['AssignAchievement']._options = None
  ...
  _globals['_ACHIEVEMENTSERVICE'].methods_by_name['UnassignAchievement']._options = None

...
class AccountServiceClient:
    ...
    def CreateAccount(self, request, **kwargs):
        path = "/account"
    ...
    def DescribeAccount(self, request, **kwargs):
        path = "/account"
    ...
    def UpdateAccount(self, request, **kwargs):
        path = "/account"
    ...
    def ResendVerification(self, request, **kwargs):
    ...
    def CompleteVerification(self, request, **kwargs):

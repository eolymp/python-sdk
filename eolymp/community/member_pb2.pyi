...
class Member(_message.Message):
    __slots__ = ["active", "attributes", "created_at", "fallback_tier_id", "ghost", "groups", "id", "incomplete", "name", "rank", "rank_length", "score", "secret", "stats", "team", "tier_id", "unofficial", "url", "user"]

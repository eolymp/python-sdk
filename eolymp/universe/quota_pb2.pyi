...
class Quota(_message.Message):
    __slots__ = ["active_contests_per_space", "attributes_per_space", "code_templates_per_problem", "contest_duration", "contest_upsolve", "contests_per_space", "courses_per_space", "customer_support_reply_time", "dedicated_user_database", "editorial_per_problem", "ghost_participants", "members_per_space", "monthly_contests_per_space", "monthly_evaluations_by_seat", "participants_per_contest", "permissions_per_space", "plagiarism_analysis", "priority_testing_queue", "problems_per_contest", "problems_per_space", "scoreboards_per_space", "single_sing_on", "solutions_per_problem", "statement_per_problem", "team_contests", "tests_per_problem", "testset_per_problem", "unofficial_participants"]
    ...
    CONTEST_DURATION_FIELD_NUMBER: _ClassVar[int]
    CONTEST_UPSOLVE_FIELD_NUMBER: _ClassVar[int]
    ...
    PRIORITY_TESTING_QUEUE_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, permissions_per_space: _Optional[int] = ..., single_sing_on: bool = ..., dedicated_user_database: bool = ..., attributes_per_space: _Optional[int] = ..., customer_support_reply_time: _Optional[int] = ..., monthly_evaluations_by_seat: _Optional[int] = ..., priority_testing_queue: bool = ..., plagiarism_analysis: bool = ..., members_per_space: _Optional[int] = ..., scoreboards_per_space: _Optional[int] = ..., courses_per_space: _Optional[int] = ..., problems_per_space: _Optional[int] = ..., tests_per_problem: _Optional[int] = ..., testset_per_problem: _Optional[int] = ..., statement_per_problem: _Optional[int] = ..., editorial_per_problem: _Optional[int] = ..., solutions_per_problem: _Optional[int] = ..., code_templates_per_problem: _Optional[int] = ..., contests_per_space: _Optional[int] = ..., active_contests_per_space: _Optional[int] = ..., monthly_contests_per_space: _Optional[int] = ..., problems_per_contest: _Optional[int] = ..., participants_per_contest: _Optional[int] = ..., contest_upsolve: bool = ..., contest_duration: _Optional[int] = ..., team_contests: bool = ..., ghost_participants: bool = ..., unofficial_participants: bool = ...) -> None: ...

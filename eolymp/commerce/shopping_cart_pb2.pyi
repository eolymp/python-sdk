...
class ShoppingCart(_message.Message):
    ...
    class Item(_message.Message):
        __slots__ = ("id", "product_id", "variant_id", "quantity", "currency", "unit_price", "total_price", "discount_price")
        ...
        total_price: int
        discount_price: int
        def __init__(self, id: _Optional[str] = ..., product_id: _Optional[str] = ..., variant_id: _Optional[str] = ..., quantity: _Optional[int] = ..., currency: _Optional[str] = ..., unit_price: _Optional[int] = ..., total_price: _Optional[int] = ..., discount_price: _Optional[int] = ...) -> None: ...
    ID_FIELD_NUMBER: _ClassVar[int]

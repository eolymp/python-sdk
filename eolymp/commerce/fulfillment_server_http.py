...
class FulfillmentServiceClient:
    ...
    def MarkReturnedOrder(self, request, **kwargs):
        path = "/store/orders/"+urllib.parse.quote(request.order_id)+"/return"
        ...
        return self.transport.request(
            ...
            url=self.url+path,
            request_data=request,
            response_symbol=_sym_db.GetSymbol("eolymp.commerce.MarkReturnedOrderOutput"),
            **kwargs,
        )

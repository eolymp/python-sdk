...
class Order(_message.Message):
    ...
    class Payment(_message.Message):
        ...
        class Status(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
            __slots__ = ()
            UNKNOWN_STATUS: _ClassVar[Order.Payment.Status]
            NOT_REQUIRED: _ClassVar[Order.Payment.Status]
            UNPAID: _ClassVar[Order.Payment.Status]
            PROCESSING: _ClassVar[Order.Payment.Status]
            PAID: _ClassVar[Order.Payment.Status]
            REFUNDED: _ClassVar[Order.Payment.Status]
        UNKNOWN_STATUS: Order.Payment.Status
        NOT_REQUIRED: Order.Payment.Status
        UNPAID: Order.Payment.Status
        PROCESSING: Order.Payment.Status
        PAID: Order.Payment.Status
        REFUNDED: Order.Payment.Status

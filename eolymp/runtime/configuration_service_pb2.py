...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['_CONFIGURATIONSERVICE'].methods_by_name['DescribeRuntimeConfig']._options = None
  ...
  _globals['_CONFIGURATIONSERVICE'].methods_by_name['ConfigureRuntimeConfig']._options = None

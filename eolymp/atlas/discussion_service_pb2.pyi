...
class DescribeMessageInput(_message.Message):
    __slots__ = ("problem_id", "message_id", "render", "extra")
    ...
    def __init__(self, problem_id: _Optional[str] = ..., message_id: _Optional[str] = ..., render: _Optional[bool] = ..., extra: _Optional[_Iterable[_Union[_message_pb2.Message.Extra, str]]] = ...) -> None: ...
...
class ListMessagesInput(_message.Message):
    __slots__ = ("problem_id", "render", "after", "size", "sort", "order", "filters", "extra")
...
class PostMessageInput(_message.Message):
    __slots__ = ("problem_id", "message", "reply_to")
    PROBLEM_ID_FIELD_NUMBER: _ClassVar[int]
    MESSAGE_FIELD_NUMBER: _ClassVar[int]
    REPLY_TO_FIELD_NUMBER: _ClassVar[int]
    problem_id: str
    message: _message_pb2.Message
    reply_to: str
    def __init__(self, problem_id: _Optional[str] = ..., message: _Optional[_Union[_message_pb2.Message, _Mapping]] = ..., reply_to: _Optional[str] = ...) -> None: ...
...
class UpdateMessageInput(_message.Message):
    __slots__ = ("problem_id", "message_id", "message")
    PROBLEM_ID_FIELD_NUMBER: _ClassVar[int]
    MESSAGE_ID_FIELD_NUMBER: _ClassVar[int]
    MESSAGE_FIELD_NUMBER: _ClassVar[int]
    problem_id: str
    message_id: str
    message: _message_pb2.Message
    def __init__(self, problem_id: _Optional[str] = ..., message_id: _Optional[str] = ..., message: _Optional[_Union[_message_pb2.Message, _Mapping]] = ...) -> None: ...
...
class DeleteMessageInput(_message.Message):
    __slots__ = ("problem_id", "message_id", "reason")
    PROBLEM_ID_FIELD_NUMBER: _ClassVar[int]
    MESSAGE_ID_FIELD_NUMBER: _ClassVar[int]
    ...
    message_id: str
    reason: str
    def __init__(self, problem_id: _Optional[str] = ..., message_id: _Optional[str] = ..., reason: _Optional[str] = ...) -> None: ...
...
class VoteMessageInput(_message.Message):
    __slots__ = ("problem_id", "message_id", "vote")
    PROBLEM_ID_FIELD_NUMBER: _ClassVar[int]
    MESSAGE_ID_FIELD_NUMBER: _ClassVar[int]
    ...
    message_id: str
    vote: int
    def __init__(self, problem_id: _Optional[str] = ..., message_id: _Optional[str] = ..., vote: _Optional[int] = ...) -> None: ...
...
class ListMessageChangesInput(_message.Message):
    __slots__ = ("problem_id", "message_id")
    PROBLEM_ID_FIELD_NUMBER: _ClassVar[int]
    MESSAGE_ID_FIELD_NUMBER: _ClassVar[int]
    problem_id: str
    message_id: str
    def __init__(self, problem_id: _Optional[str] = ..., message_id: _Optional[str] = ...) -> None: ...
...
class UpdateSubscriptionInput(_message.Message):
    __slots__ = ("problem_id", "subscription")
    PROBLEM_ID_FIELD_NUMBER: _ClassVar[int]
    SUBSCRIPTION_FIELD_NUMBER: _ClassVar[int]
    problem_id: str
    subscription: _subscription_pb2.Subscription
    def __init__(self, problem_id: _Optional[str] = ..., subscription: _Optional[_Union[_subscription_pb2.Subscription, _Mapping]] = ...) -> None: ...

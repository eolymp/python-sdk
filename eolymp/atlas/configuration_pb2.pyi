...
class Config(_message.Message):
    __slots__ = ("hourly_ip_submission_limit", "daily_ip_submission_limit")
    ...
    def __init__(self, hourly_ip_submission_limit: _Optional[int] = ..., daily_ip_submission_limit: _Optional[int] = ...) -> None: ...

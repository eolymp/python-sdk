...
class Interactor(_message.Message):
    ...
    def __init__(self, type: _Optional[_Union[_interactor_pb2.Interactor.Type, str]] = ..., runtime: _Optional[str] = ..., source_url: _Optional[str] = ..., secret: bool = ..., files: _Optional[_Iterable[_Union[_file_pb2.File, _Mapping]]] = ...) -> None: ...

...
class Snapshot(_message.Message):
    __slots__ = ("schema", "problem", "testing", "checker", "interactor", "validator", "statements", "templates", "attachments", "testsets", "tests", "editorials", "solutions", "scripts", "questions")

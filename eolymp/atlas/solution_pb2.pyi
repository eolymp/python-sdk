...
class Solution(_message.Message):
    ...
    submission_id: str
    def __init__(self, id: _Optional[str] = ..., name: _Optional[str] = ..., secret: _Optional[bool] = ..., runtime: _Optional[str] = ..., source: _Optional[str] = ..., type: _Optional[_Union[Solution.Type, str]] = ..., status: _Optional[_Union[Solution.Status, str]] = ..., submission_id: _Optional[str] = ...) -> None: ...

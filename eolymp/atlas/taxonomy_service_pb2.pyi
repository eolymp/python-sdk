...
from eolymp.atlas import taxonomy_topic_pb2 as _taxonomy_topic_pb2
...
class CreateTopicInput(_message.Message):
    ...
    topic: _taxonomy_topic_pb2.Topic
    def __init__(self, topic: _Optional[_Union[_taxonomy_topic_pb2.Topic, _Mapping]] = ...) -> None: ...
...
class ListTopicsOutput(_message.Message):
    ...
    items: _containers.RepeatedCompositeFieldContainer[_taxonomy_topic_pb2.Topic]
    total: int
    def __init__(self, total: _Optional[int] = ..., items: _Optional[_Iterable[_Union[_taxonomy_topic_pb2.Topic, _Mapping]]] = ...) -> None: ...
...
class ListTranslationsOutput(_message.Message):
    ...
    ITEMS_FIELD_NUMBER: _ClassVar[int]
    TOTAL_FIELD_NUMBER: _ClassVar[int]
    items: _containers.RepeatedCompositeFieldContainer[_taxonomy_topic_pb2.Topic.Translation]
    total: int
    def __init__(self, total: _Optional[int] = ..., items: _Optional[_Iterable[_Union[_taxonomy_topic_pb2.Topic.Translation, _Mapping]]] = ...) -> None: ...
...
class TranslateTopicInput(_message.Message):
    ...
    locale: str
    topic_id: str
    translation: _taxonomy_topic_pb2.Topic.Translation
    def __init__(self, topic_id: _Optional[str] = ..., locale: _Optional[str] = ..., translation: _Optional[_Union[_taxonomy_topic_pb2.Topic.Translation, _Mapping]] = ...) -> None: ...
...
class UpdateTopicInput(_message.Message):
    ...
    topic: _taxonomy_topic_pb2.Topic
    topic_id: str
    def __init__(self, patch: _Optional[_Iterable[_Union[UpdateTopicInput.Patch, str]]] = ..., topic_id: _Optional[str] = ..., topic: _Optional[_Union[_taxonomy_topic_pb2.Topic, _Mapping]] = ...) -> None: ...

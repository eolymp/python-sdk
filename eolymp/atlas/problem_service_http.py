...
class ProblemServiceClient:
    ...
    def ExportProblem(self, request, **kwargs):
        path = "/problems/"+urllib.parse.quote(request.problem_id)+"/snapshot"
        ...
        return self.transport.request(
            ...
            url=self.url+path,
            request_data=request,
            response_symbol=_sym_db.GetSymbol("eolymp.atlas.ExportProblemOutput"),
            **kwargs,
        )

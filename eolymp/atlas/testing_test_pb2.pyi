...
class Test(_message.Message):
    __slots__ = ("id", "testset_id", "index", "status", "status_message", "example", "inactive", "secret", "score", "example_input_url", "example_answer_url", "generated_input_url", "generated_answer_url", "input_url", "input_generator", "answer_url", "answer_generator")

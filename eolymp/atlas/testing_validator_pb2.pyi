...
class Validator(_message.Message):
    ...
    def __init__(self, version_id: _Optional[str] = ..., secret: _Optional[bool] = ..., runtime: _Optional[str] = ..., source: _Optional[str] = ..., files: _Optional[_Iterable[_Union[_file_pb2.File, _Mapping]]] = ...) -> None: ...

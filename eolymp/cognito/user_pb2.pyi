...
class User(_message.Message):
    __slots__ = ("id", "username", "email", "active", "rating", "name", "picture", "company", "occupation", "country", "city", "email_status", "email_verified", "birthday", "registered_on", "last_activity", "username_changed_on", "password_changed_on", "locale", "pronoun", "aliases", "discord_user_id")
